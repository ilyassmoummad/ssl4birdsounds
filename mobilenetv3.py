...
class Projector(nn.Module):
    """Projector"""
    def __init__(self, model_name='mobilenetv3'):
        super(Projector, self).__init__()
        dim = model_dim[model_name]
        self.hidden_dim = dim
        self.out_dim = dim
        self.mlp = nn.Sequential(nn.Linear(model_dim[model_name], self.hidden_dim, bias=False),
...
if __name__ == "__main__":
    ...
    #print(summary(model, input_size=(1, 1, 128, 251)))
    print(summary(model))