...
class CNN14(nn.Module):
    def __init__(self, num_classes=4, do_dropout=False, embed_only=False, from_scratch=False, path_to_weights="/users/local/Cnn14_mAP=0.431.pth", device="cuda"):
        ...
        self.cnn14 = _CNN14(num_classes=num_classes, do_dropout=do_dropout, embed_only=embed_only)
        if not from_scratch:
            weights = torch.load(path_to_weights, map_location="cpu")['model']
        ...
        self.cnn14 = self.cnn14.to(device)
