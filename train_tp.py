...
from dataset_tp import BirdClef2020, MEAN, STD
...
def train(encoder, projector, train_loader, train_transform, loss_fn, optim, args):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        for x1, x2, y in tqdm(train_loader):
            ...
            x1 = train_transform(x1); x2 = train_transform(x2)
...
if __name__ == "__main__":
    ...
    # Dataloader
    train_birdclef = BirdClef2020(args, datapath=args.datapath, split='train', notpruned=args.notpruned)
